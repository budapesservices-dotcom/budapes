...
const imagesPage2 = [
  {
    url: "/discography/manggaring-katresnan/manggaring-katresnan.jpg",
    title: "MANGGARING KATRESNAN",
    titleEn: "MANGGARING KATRESNAN",
    lrcUrl: "/discography/manggaring-katresnan/manggaring-katresnan.lrc",
    songUrl: "/discography/manggaring-katresnan/manggaring-katresnan.mp3",
    year: "2024",
  ...
  {
    url: "/discography/merindu/merindu.jpg",
    title: "MERINDU",
    titleEn: "MERINDU",
    lrcUrl: "/discography/merindu/merindu.lrc",
    songUrl: "/discography/merindu/merindu.mp3",
    year: "2024",
    genre: "Pop Rock",
    bgColor: "#F494A4",
    textColor: "#C5FED3",
  ...
  {
    url: "/discography/wijaya-kusuma/wijaya-kusuma.jpg",
    title: "WIJOYO KUSUMO",
    titleEn: "WIJOYO KUSUMO",
    lrcUrl: "/discography/wijaya-kusuma/wijaya-kusuma.lrc",
    songUrl: "/discography/wijaya-kusuma/wijaya-kusuma.mp3",
    year: "2024",
  ...
  {
    url: "/discography/biru/biru.jpg",
    title: "BIRU",
    titleEn: "BIRU",
    lrcUrl: "/discography/biru/biru.lrc",
    songUrl: "/discography/biru/biru.mp3",
    year: "2024",
    genre: "Pop, Country",
    bgColor: "#2E1C13",
    textColor: "#E7A146",
  ...
  {
    url: "/discography/tirai/tirai.jpg",
    title: "TIRAI",
    titleEn: "TIRAI",
    lrcUrl: "/discography/tirai/tirai.lrc",
    songUrl: "/discography/tirai/tirai.mp3",
    year: "2024",
    genre: "Pop, Ballad",
    bgColor: "#2E894C",
    textColor: "#F9A090",
  ...
  {
    url: "/discography/wanita-sejatiku/wanita-sejatiku.jpg",
    title: "WANITA SEJATIKU",
    titleEn: "WANITA SEJATIKU",
    lrcUrl: "/discography/wanita-sejatiku/wanita-sejatiku.lrc",
    songUrl: "/discography/wanita-sejatiku/wanita-sejatiku.mp3",
    year: "2024",
  ...
  {
    url: "/discography/sandyakala/sandyakala.jpg",
    title: "SANDYAKALA",
    titleEn: "SANDYAKALA",
    lrcUrl: "/discography/sandyakala/sandyakala.lrc",
    songUrl: "/discography/sandyakala/sandyakala.mp3",
    year: "2024",
    genre: "Pop, Country",
    bgColor: "#110604",
    textColor: "#B94846",
  ...
  {
    url: "/discography/kosong/kosong.jpg",
    title: "KOSONG",
    titleEn: "KOSONG",
    lrcUrl: "/discography/kosong/kosong.lrc",
    songUrl: "/discography/kosong/kosong.mp3",
    year: "2025",
  ...
  {
    url: "/discography/ngopi/ngopi.jpg",
    title: "NGOPI",
    titleEn: "NGOPI",
    lrcUrl: "/discography/ngopi/ngopi.lrc",
    songUrl: "/discography/ngopi/ngopi.mp3",
    year: "2025",
    genre: "Reggae, Pop",
    bgColor: "#555320",
    textColor: "#DADADA",
  ...
  {
    url: "/discography/fenomena-jokowi/fenomena-jokowi.jpg",
    title: "FENOMENA JOKOWI",
    titleEn: "FENOMENA JOKOWI",
    lrcUrl: "/discography/fenomena-jokowi/fenomena-jokowi.lrc",
    songUrl: "/discography/fenomena-jokowi/fenomena-jokowi.mp3",
    year: "2025",
  ...
  {
    url: "/discography/dua-kekuatan/dua-kekuatan.jpg",
    title: "DUA KEKUATAN",
    titleEn: "DUA KEKUATAN",
    lrcUrl: "/discography/dua-kekuatan/dua-kekuatan.lrc",
    songUrl: "/discography/dua-kekuatan/dua-kekuatan.mp3",
    year: "2025",
    genre: "House, Dupstep",
    bgColor: "#6B8894",
    textColor: "#E3D588",
  ...
  {
    url: "/discography/mahligai-yang-retak/mahligai-yang-retak.jpg",
    title: "MAHLIGAI YANG RETAK",
    titleEn: "MAHLIGAI YANG RETAK",
    lrcUrl: "/discography/mahligai-yang-retak/mahligai-yang-retak.lrc",
    songUrl: "/discography/mahligai-yang-retak/mahligai-yang-retak.mp3",
    year: "2025",
    genre: "Pop, Melayu",
    bgColor: "#050505",
    textColor: "#ef4444",
  ...
  {
    url: "/discography/mahligai-yang-retak-acoustic/mahligai-yang-retak-acoustic.jpg",
    title: "MAHLIGAI YANG RETAK (ACOUSTIC)",
    titleEn: "MAHLIGAI YANG RETAK (ACOUSTIC)",
    lrcUrl:
      "/discography/mahligai-yang-retak-acoustic/mahligai-yang-retak-acoustic.lrc",
    songUrl:
      "/discography/mahligai-yang-retak-acoustic/mahligai-yang-retak-acoustic.mp3",
    year: "2025",
  ...
  {
    url: "/discography/tak-ingin-ku-jauh/tak-ingin-ku-jauh.jpg",
    title: "TAK INGIN KU JAUH",
    titleEn: "TAK INGIN KU JAUH",
    lrcUrl: "/discography/tak-ingin-ku-jauh/tak-ingin-ku-jauh.lrc",
    songUrl: "/discography/tak-ingin-ku-jauh/tak-ingin-ku-jauh.mp3",
    year: "2025",
    genre: "Alternative, Rock",
    bgColor: "#B2B29B",
    textColor: "#FFFFDD",
  ...
  {
    url: "/discography/pengembara-dimensi/pengembara-dimensi.jpg",
    title: "PENGEMBARA DIMENSI",
    titleEn: "PENGEMBARA DIMENSI",
    lrcUrl: "/discography/pengembara-dimensi/pengembara-dimensi.lrc",
    songUrl: "/discography/pengembara-dimensi/pengembara-dimensi.mp3",
    year: "2025",
  ...
  {
    url: "/discography/lukisan-dara/lukisan-dara.jpg",
    title: "LUKISAN DARA",
    titleEn: "LUKISAN DARA",
    lrcUrl: "/discography/lukisan-dara/lukisan-dara.lrc",
    songUrl: "/discography/lukisan-dara/lukisan-dara.mp3",
    year: "2025",
    genre: "Pop, Rock",
    bgColor: "#EFE4BE",
    textColor: "#141212",
